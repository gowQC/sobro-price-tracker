...
// https://chatgpt.com/c/6795a669-f91c-41f0-a482-7c6b357a70c7 >> MIGHT BE SOLUTION
    ...
    try {
        ...
        if (URL == "https://www.amazon.com/Sobro-SOCTB300-Refrigerator-Bluetooth-Speakers/dp/B07S85JTZD") { 
            ...
            if(priceNumber < value) {
                return { Price: priceNumber, Color: "Green", Message: "On sale! :D"}; //on sale
            }
            else if (priceNumber == value) {
                return { Price: priceNumber, Color: "Gray", Message: "Same price."}; //remains unchanged
            }
            else {
                return { Price: priceNumber, Color: "Red", Message: "Price went up :("}; //price increase
            }  
        }
        ...
        //sobro link - works fine
            ...
            nightmare.end();
            console.log(typeof(priceString)); //doesn't go here on second attempt
            const priceNumber = parseFloat(priceString.replace('$','').replace(',',''));
            console.log("retrieved priceNumber");
        ...
        //macys link - brings 403 error with .goto() method. code should work + abide by the robots.txt but for some reason still unable to scrape page
...
// const _scrapePrice = { scrapePrice };
// export { _scrapePrice as scrapePrice };
